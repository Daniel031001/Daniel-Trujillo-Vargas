...
public class Pila_1 {
    ...
    public static void main(final String[] args) {
        final Scanner abc = new Scanner(System.in);
        int letras = 0;// se inicializa nuestra variable
        int op;// do while y switch
        char le = 'a';
        // char let='A';
        final char pila[] = new char[27];/// nuestra pila almacena 27 espacios
        do {
...
le++;                        }
                ...
                default:
                    System.out.println("No se encuentra en el menu :(, favor de seleccionar otra opcion");
